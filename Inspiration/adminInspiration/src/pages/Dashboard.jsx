    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="card">
          ...
          <div className="mt-6">
            <Link to="/students" className="btn-primary w-full flex items-center justify-center">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/tournaments" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
              View all
            </Link>
          </div>
          ...
          <div className="mt-6">
            <Link to="/tournaments" className="btn-primary w-full flex items-center justify-center">
              <Plus className="h-4 w-4 mr-2" />
              Add New Tournament
            </Link>
          </div>
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link to="/students" className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
          ...
          <Link to="/tournaments" className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
